...
case $TARGET_ARCH in
  aarch64)
    _gen_buildrules ${AARCH64_SOURCES[@]}
    ;;
  x86_64)
...
echo "build builtins.a: ar ${ALL_OBJECTS[*]}" >> $NF
echo "default builtins.a" >> $NF

ninja -f $NF

mkdir -p "$DESTDIR/lib/linux"
cp "$DESTDIR/builtins.a" "$DESTDIR/lib/linux/libclang_rt.builtins-$TARGET_ARCH.a"
